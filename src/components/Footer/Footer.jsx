    ...
    return (
        <footer className="bg-[#001931] text-neutral-content p-10">
            <div className="flex flex-col items-center">
                <div className="flex flex-col sm:flex-row justify-between items-center w-full max-w-11/12 mb-6">
                    ...
                    <nav className="mb-4 sm:mb-0">
                        <h6 className="footer-title text-center sm:text-left">Social Links</h6>
                ...
                <div className="w-full text-center">
                    <div className="border-t border-gray-700 pt-6 w-full max-w-11/12 mx-auto">
